  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="ghost" size="icon" className="relative h-10 w-10 hover:bg-accent hover:text-accent-foreground transition-colors group touch-manipulation" aria-label="Carrito de compra">
